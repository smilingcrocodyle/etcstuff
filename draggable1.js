...
Draggable.prototype.move = function() {
    ...
    var elementTop = event.clientY + (event.clientX - this.element.element.getBoundingClientRect().top),
    elementLeft = event.clientX + (event.clientX - this.element.element.getBoundingClientRect().left);
